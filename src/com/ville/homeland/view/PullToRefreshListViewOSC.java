 ...
 * @created 2012-3-21
 */
public class PullToRefreshListViewOSC extends ListView implements OnScrollListener {  
    ...
    public PullToRefreshListViewOSC(Context context, AttributeSet attrs) {  
        super(context, attrs);  
        init(context);  
    }  
    
    public PullToRefreshListViewOSC(Context context, AttributeSet attrs, int defStyle) {  
    ...
    private void init(Context context) {   
        ...
        mLvFoot = (LinearLayout) inflater.inflate(R.layout.pull_to_refresh_footer, null);
        ...
        addFooterView(mLvFoot);
//        mLvFoot.setVisibility(View.GONE);
...
//    	System.out.println("onScrollStateChanged " + view.getChildCount());
    	if(view != null) {
//    		if(view.getChildCount() == 2){
//    			System.out.println("onScrollStateChanged View.Gone");
//    			mLvFoot.setVisibility(View.GONE);
//    		}else {
//    			System.out.println("onScrollStateChanged View.VISIBLE" + view.getChildCount());
//    			mLvFoot.setVisibility(View.VISIBLE);
//    		}
    	}
    	boolean scrollEnd = false;
		try{
			if(view.getPositionForView(mLvFoot) == view.getLastVisiblePosition()){
				scrollEnd = true;
			}
		} catch (Exception e){
			scrollEnd = false;
		}
		if(scrollEnd && mStateLoadMore != STATE_LOADING){
			mStateLoadMore = STATE_LOADING;
			onLoadMore();
		}
    }  
